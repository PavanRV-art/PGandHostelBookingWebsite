...
const HostelRooms = () => {
    ...
    return (
        ...
        <div
            className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md: pt - 36 px - 4 md: px - 16 lg: px - 24 xl: px - 32">
            {/* ---------- Rooms Section ---------- */}
            ...
            border-b border-gray-300 last:border-0"
              ...
              object-cover cursor-pointer"
                ...
                {/* --------hostel2- */}
                {
                    hostel2roomsDummyData.map((room) => (
                        <div
                            key={room._id}
                            className="flex flex-col md:flex-row items-start py-10 gap-6
            border-b border-gray-300 last:border-0"
              ...
              object-cover cursor-pointer"
                ...
                {/* --------- hostel 3 */}
                {
                    hostel3roomsDummyData.map((room) => (
                        <div
                            key={room._id}
                            className="flex flex-col md:flex-row items-start py-10 gap-6
            border-b border-gray-300 last:border-0"
              ...
              object-cover cursor-pointer"
                ...
                {/* --------- hostel 4 */}
                {
                    hostel4roomsDummyData.map((room) => (
                        <div
                            key={room._id}
                            className="flex flex-col md:flex-row items-start py-10 gap-6
            border-b border-gray-300 last:border-0"
              ...
              object-cover cursor-pointer"
                ...
                {/* --------- hostel 5 */}
                {
                    hostel5roomsDummyData.map((room) => (
                        <div
                            key={room._id}
                            className="flex flex-col md:flex-row items-start py-10 gap-6
            border-b border-gray-300 last:border-0"
